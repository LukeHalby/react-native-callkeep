...
// src/index.ts
import { NativeModules as NativeModules2, Platform as Platform2, Alert } from "react-native";

// src/actions.ts
import { NativeModules, NativeEventEmitter, Platform } from "react-native";
var RNCallKeepModule = NativeModules.RNCallKeep;
var eventEmitter = new NativeEventEmitter(RNCallKeepModule);
...
// src/index.ts
var RNCallKeepModule2 = NativeModules2.RNCallKeep;
var isIOS2 = Platform2.OS === "ios";
var supportConnectionService = !isIOS2 && Platform2.Version >= 23;
...
var RNCallKeep = class {
  ...
  backToForeground() {
    ...
    NativeModules2.RNCallKeep.backToForeground();
  }
  getInitialEvents() {
